...
<title><?php echo $title; ?> | CGS - SUST</title>
...
<div class="navbar-fixed-top navbar-TOPsm  col-md-10    col-md-offset-1"    role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >College of Graduate Studies</h5>
        ...
        <ul class="navbar-nav p navbar-left tooltip-demo" style="margin-left:-8%;"> 
            <li class="dropdown dropdown-toggle ">
              <a  data-toggle="tooltip" data-placement="left" title="Contact Us"   href="<?php echo web_root.'index.php?q=contact';  ?>"> 
               <i class="fa fa-phone fa-fw"> </i>  Call Us: +249183796854   or Email Us: cgs@sustech.edu
              </a>
            </li>
            <li><span> |   | </span></li>
            <li>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" >College of Graduate Studies</h1>
        </a>
    </p>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="panel panel-default">
                  <div class="panel-heading" style="background-color:#660000;color:#fff;">
                  <b><?php   
...
?>
            ...
            <footer class="panel-footer" style="background-color:#660000;color:#fff;" >
              <p align="left" >&copy; Sudan University of Science and Technology</p>
           </footer>
      </div>
