...
$_SESSION['PASS']    	  =  $_POST['PASS']; 
 	...
 	$student = New Student();
	$res = $student->find_all_student($_POST['NAME']);
...
if($userStud){
    ...
    if ($age < 19){
       message("Cannot Proceed. Must be 19 years old and above to enroll.", "error");
       redirect("index.php?q=enrol");
	...
	<div class="col-md-4"><label>Academic Year: <?php echo $_SESSION['SY'] ; ?></label></div>
		<table class="table">
			...
			<tr>
				...
				<td colspan="5" >
					<input required="true"   class="form-control input-md" id="NAME" name="NAME" placeholder="Full Name" type="text" value="<?php echo isset($_SESSION['NAME']) ? $_SESSION['NAME'] : ''; ?>">
 				</td>
			...
			<td><label>Contact No.</label></td>
				<td colspan="6"><input required="true"  class="form-control input-md" id="CONTACT" name="CONTACT" placeholder="Contact Number" type="number" maxlength="10" value="<?php echo isset($_SESSION['CONTACT']) ? $_SESSION['CONTACT'] : ''; ?>">
							</td>
